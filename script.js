...
for(let keys in product){
    ...
    <div class="max-w-sm self-center">
    <img src="${womanProducts[keys].gambarUrl}" alt="${womanProducts[keys].productName}">
    <div class="mt-5 flex flex-col gap-1">
        <h1 class="font-semibold">${womanProducts[keys].brand}</h1>
        <h1 class="font-bold">${womanProducts[keys].productName}</h1>
        <h1 class="font-light">Rp.${womanProducts[keys].harga}</h1>
    </div>`
}
...
for(let keys in product){
    ...
    <div class="max-w-sm self-center">
    <img src="${kidProducts[keys].gambarUrl}" alt="${kidProducts[keys].productName}">
    <div class="mt-5 flex flex-col gap-1">
        <h1 class="font-semibold">${kidProducts[keys].brand}</h1>
        <h1 class="font-bold">${kidProducts[keys].productName}</h1>
        <h1 class="font-light">Rp.${kidProducts[keys].harga}</h1>
    </div>`
}